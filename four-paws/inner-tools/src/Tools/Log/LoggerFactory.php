 ...
 *
 * TODO Написать на замену LoggerBuilder, чтобы в services.yml можно было под каждый сервис собирать и настраивать
 *     желаемый логгер
 */
abstract class LoggerFactory
{
     ...
     */
    public static function create($logName, $logType = 'main', $tryStdOut = true): LoggerInterface
    {
        ...
        if (trim($logName) == '' || preg_match('/[^A-Z_0-9]/i', $logName)) {
